  ...
  const reducer = (state, action) => {
    switch (action.type) {
      case "update":
        ...
        return {
          ...state,
          [key]: { value: val, error, touched, valid },
          formValid,
        };
      case "reset":
        return init;
        ...
        <div className="col-md-4 mt-5">
          <form>
            ...
            <div
              style={{
                display:
                  !customer.fname.valid && customer.fname.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.fname.error}</p>
            </div>
            ...
            <div
              style={{
                display:
                  !customer.lname.valid && customer.lname.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.lname.error}</p>
            </div>
            ...
            <div
              style={{
                display:
                  !customer.email.valid && customer.email.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.email.error}</p>
            </div>
            ...
            <div
              style={{
                display:
                  !customer.contact.valid && customer.contact.touched
                    ? "block"
                    : "none",
              }}
            >
            ...
            <div
              style={{
                display:
                  !customer.weight.valid && customer.weight.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.weight.error}</p>
            </div>
            ...
            <div
              style={{
                display:
                  !customer.height.valid && customer.height.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.height.error}</p>
            </div>
            <br />
            ...
            <div
              style={{
                display:
                  !customer.address.valid && customer.address.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.address.error}</p>
            </div>
            ...
            <div
              style={{
                display:
                  !customer.username.valid && customer.username.touched
                    ? "block"
                    : "none",
              }}
            >
            ...
            <div
              style={{
                display:
                  !customer.password.valid && customer.password.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.password.error}</p>
            </div>
            <p
              className="text-success"
              style={{ display: customer.password.valid ? "block" : "none" }}
            >
              {customer.password.error}
            </p>
            <label className="form-label" for="rpass">
            ...
            <div
              style={{
                display:
                  !customer.repassword.valid && customer.repassword.touched
                    ? "block"
                    : "none",
              }}
            >
              <p className="text-danger">{customer.repassword.error}</p>
            </div>
            <p style={{ float: "right" }}>
