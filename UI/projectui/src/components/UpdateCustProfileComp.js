...
export const UpdateCustProfile=()=>{
    ...
    const init = {
        fname : {value:JSON.stringify(initCust.fname),error:"",touched:false,valid:false}, 
    ...
    return(
        ...
        <div>
            ...
            <h1 style={{fontFamily:"Antic Didone"}}>Update USER Profile</h1>
            </div>
            <div className="row justify-content-center">
            <div className="col-md-4 mt-5"> 
            <div>{JSON.stringify(initCust)}</div>
            <div>{JSON.stringify(initCust.fname)}</div>
            <form>
                    <label className="form-label" for="fname">Enter First Name</label>
                    <input type="text" className="form-control" id="fname" name="fname" value={customer.fname.value} onChange={(e)=>{handleChange("fname",e.target.value)}} onBlur={(e)=>{handleChange("fname",e.target.value)}}/><br/>
                    ...
                    <input type="text" className="form-control" id="lname" name="lname" value={customer.lname.value} onChange={(e)=>{handleChange("lname",e.target.value)}} onBlur={(e)=>{handleChange("lname",e.target.value)}}/><br/>
